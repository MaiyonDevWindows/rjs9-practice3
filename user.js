...
// console.log(user1.name); Error vì thuộc tính là private.
user1.login('user1', '123456');
user1.setPassword('12'); // Validate password phải lớn hơn 6 ký tự.
var Author = /** @class */ (function (_super) {
    ...
    Author.prototype.login = function (username, password) {
        if (username === this.username && password === this.password) {
